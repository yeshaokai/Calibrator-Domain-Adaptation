...
def save_seg_results(source_img,source_out,label,id):    
    ...
    root = '/home/lthpc/data_calibrator/gta_source'
    #source_img_path = os.path.join(root,'source_img_{}.png'.format(id))
    source_out_path = os.path.join(root,'source_out_{}.png'.format(id))
